...
python -m torch.distributed.launch --nproc_per_node=8 --use_env search_spaces/AutoFormer/supernet_train.py --data-path . --gp --change_qkv --relative_position --mode super --dist-eval --cfg search_spaces/AutoFormer/experiments/supernet/supernet-T.yaml --epochs 1500 --warmup-epochs 20 --output "output_autoformer_drnas_0.5_smaller_lr" --batch-size 64 --one_shot_opt drnas --use_we_v2 --amp --min-lr 1e-5 --lr 1e-4 --warmup-lr 1e-6
