...
pthfile="pretrained_models/autoformer/checkpoint_750.pth"
python -m torch.distributed.launch --nproc_per_node=8  --master_port=1723 --use_env search_spaces/AutoFormer/supernet_train_inherit.py --data-set CIFAR100 --gp --change_qkv --relative_position --mode super --dist-eval --cfg search_spaces/AutoFormer/experiments/supernet/supernet-T.yaml  --patch_size 16  --epochs 500 --warmup-epochs 20 --output autoformer_wev2_drnas_cf100_finetune/ --batch-size 64 --amp --model_path $pthfile --df_path $picklefile --arch_epoch 750 --lr 1e-5 --warmup-lr 1e-4 --min-lr 1e-6 --seed 9001
