...
python -m torch.distributed.launch --nproc_per_node=8 --use_env search_spaces/AutoFormer/supernet_train.py --data-path . --gp --change_qkv --relative_position --mode super --dist-eval --cfg search_spaces/AutoFormer/experiments/supernet/supernet-T.yaml --epochs 500 --warmup-epochs 20 --output "output_autoformer_gdas_0.8" --batch-size 64 --one_shot_opt gdas --use_we_v2 --ratio 0.8
