...
#python search_spaces/CharLM/search.py --batch-size 64 --mixop gdas --portion 0.8
#python search_spaces/CharLM/search.py --batch-size 16 --mixop drnas
python search_spaces/CharLM/train_spos.py --mixop spos --batch-size 64 --portion 0.5 --seed 9001
