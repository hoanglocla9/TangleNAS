...
python -m torch.distributed.launch --nproc_per_node=8  --master_port=1723 --use_env search_spaces/AutoFormer/supernet_train.py  --data-set CIFAR10 --gp --change_qkv --relative_position --mode super --dist-eval --cfg search_spaces/AutoFormer/experiments/supernet/supernet-T.yaml  --patch_size 16  --epochs 1500 --warmup-epochs 20 --output output_cifar10_gdas_0_5_0_5_we2_2/ --batch-size 64 --amp  --one_shot_opt  gdas --ratio 0.5 --use_we_v2
