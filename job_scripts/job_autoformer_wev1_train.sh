...
#SBATCH -J autoformer-wev1-train # sets the job name. If not specified, the file name will be used as job name
...
python -m torch.distributed.launch --nproc_per_node=8  --master_port=1723 --use_env search_spaces/AutoFormer/supernet_from_scratch.py --data-set CIFAR100 --gp --change_qkv --relative_position --mode super --dist-eval --cfg search_spaces/AutoFormer/experiments/supernet/supernet-T.yaml  --patch_size 16  --epochs 500 --warmup-epochs 20 --output autoformer_wev1_drnas_cf100_train/ --batch-size 64 --amp --df_path $picklefile --arch_epoch 272 --seed 9001
echo "Finish"