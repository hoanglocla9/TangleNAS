...
def main(args):
    ...
    train_loss_scaler = NativeScaler()
    ...
    if args.resume:
        ...
        if not args.eval and 'optimizer' in checkpoint and 'lr_scheduler' in checkpoint and 'epoch' in checkpoint:
            ...
            if 'scaler' in checkpoint:
                train_loss_scaler.load_state_dict(checkpoint['scaler'])
                ...
                utils.save_on_master(
                    {
                        ...
                        'epoch': epoch,
                        'scaler': train_loss_scaler.state_dict(),
                        'scaler_val': arch_loss_scaler.state_dict(),
                        'args': args,
                    }, checkpoint_path)
