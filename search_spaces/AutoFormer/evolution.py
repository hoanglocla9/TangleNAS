    ...
    def search(self):
        ...
        while self.epoch < self.max_epochs:
            ...
            for i, cand in enumerate(self.keep_top_k[50]):
                print(
                    'No.{} {} Top-1 val acc = {}, Top-1 test acc = {}, params = {}'
                    .format(i + 1, cand, self.vis_dict[cand]['acc'],
...
def get_args_parser():
    ...
    parser.add_argument('--no-prefetcher',
                        action='store_true',
                        default=False,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('AutoFormer evolution search',
