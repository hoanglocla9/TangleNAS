...
class AttentionSuper(nn.Module):
    ...
    def __init__(self,
        ...
        if change_qkv:
            self.qkv = qkv_super(super_embed_dim, 3 * 64 * 4, bias=qkv_bias)
        else:
        ...
        self.proj = LinearSuper(256, super_embed_dim)
    ...
    def set_sample_config(self,
        ...
        if not self.change_qkv:
            ...
            self.sample_scale = (self.super_embed_dim //
        ...
        #print(self.sample_qk_embed_dim // sample_num_heads)
        if self.relative_position:
