...
class Flowers(ImageFolder):
    ...
    def __init__(self, root, train=True, transform=None, **kwargs):
        ...
        for item in self.imgs:
            self.samples.append((os.path.join(root, 'jpg',
                                              "image_{:05d}.jpg".format(item)),
...
class Cars196(ImageFolder, datasets.CIFAR10):
    ...
    train_list = [['00001.jpg', '8df595812fee3ca9a215e1ad4b0fb0c4'],
    ...
    def __init__(self,
        ...
        if train:
            ...
            for item in labels:
                ...
                label = int(item[4]) - 1
                self.samples.append(
                    (os.path.join(self.root, self.base_folder_trainims,
                                  img_name), label))
        else:
            labels = \
            ...
            for item in labels:
                ...
                label = int(item[-2]) - 1
                self.samples.append(
                    (os.path.join(self.root, self.base_folder_testims,
                                  img_name), label))
...
class Pets(ImageFolder):
    ...
    def __init__(self,
        ...
        self.target_transform = None
        self.transform = transform
        train_list_path = os.path.join(self.dataset_root, 'annotations',
                                       'trainval.txt')
        test_list_path = os.path.join(self.dataset_root, 'annotations',
                                      'test.txt')
