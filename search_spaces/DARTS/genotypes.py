...
DARTS = DARTS_V2
darts_better = Genotype(normal=[('sep_conv_3x3', 0), ('sep_conv_3x3', 1),
                                ('dil_conv_3x3', 1), ('skip_connect', 0),
                                ('skip_connect', 0), ('sep_conv_3x3', 2),
                                ('sep_conv_5x5', 1), ('dil_conv_5x5', 0)],
                        normal_concat=range(2, 6),
                        reduce=[('max_pool_3x3', 1), ('avg_pool_3x3', 0),
...
darts = Genotype(normal=[('sep_conv_3x3', 0), ('sep_conv_3x3', 1),
                 ...
                 reduce=[('max_pool_3x3', 0), ('skip_connect', 1),
                         ...
                         ('skip_connect', 3), ('avg_pool_3x3', 0)],
                 reduce_concat=range(2, 6))
drnas = Genotype(normal=[('dil_conv_3x3', 1), ('sep_conv_3x3', 0),
                         ('skip_connect', 0), ('dil_conv_5x5', 2),
                         ('dil_conv_3x3', 2), ('skip_connect', 0),
                         ('dil_conv_5x5', 3), ('sep_conv_5x5', 0)],
                 normal_concat=range(2, 6),
                 reduce=[('sep_conv_3x3', 0), ('dil_conv_5x5', 1),
                         ('skip_connect', 2), ('max_pool_3x3', 0),
                         ('skip_connect', 2), ('skip_connect', 3),
                         ('skip_connect', 3), ('skip_connect', 2)],
                 reduce_concat=range(2, 6))
drnas_correct = Genotype(normal=[('sep_conv_3x3', 1), ('sep_conv_3x3', 0),
                         ...
                         reduce=[('avg_pool_3x3', 1), ('avg_pool_3x3', 0),
                                 ...
                                 ('skip_connect', 2), ('skip_connect', 3)],
                         reduce_concat=range(2, 6))
gdas = Genotype(normal=[('sep_conv_3x3', 0), ('sep_conv_3x3', 1),
                        ('sep_conv_3x3', 0), ('skip_connect', 2),
                        ('sep_conv_3x3', 0), ('dil_conv_5x5', 3),
                        ('sep_conv_5x5', 4), ('sep_conv_3x3', 0)],
                normal_concat=range(2, 6),
                reduce=[('sep_conv_5x5', 1), ('sep_conv_3x3', 0),
                        ('sep_conv_3x3', 0), ('sep_conv_3x3', 2),
                        ('sep_conv_5x5', 1), ('skip_connect', 2),
                        ('sep_conv_5x5', 3), ('skip_connect', 4)],
                reduce_concat=range(2, 6))
darts_final = Genotype(normal=[('skip_connect', 0), ('sep_conv_3x3', 1),
                               ('skip_connect', 0), ('sep_conv_3x3', 1),
                       ...
                       reduce=[('max_pool_3x3', 0), ('skip_connect', 1),
                               ...
                               ('max_pool_3x3', 0), ('skip_connect', 3),
                               ('max_pool_3x3', 0), ('skip_connect', 3)],
                       reduce_concat=range(2, 6))
drnas_final = Genotype(normal=[('sep_conv_3x3', 1), ('skip_connect', 0),
                               ('skip_connect', 0), ('sep_conv_3x3', 1),
                               ('skip_connect', 0), ('dil_conv_5x5', 1),
                               ('dil_conv_3x3', 3), ('skip_connect', 0)],
                       normal_concat=range(2, 6),
                       reduce=[('max_pool_3x3', 0), ('max_pool_3x3', 1),
                               ...
                               ('max_pool_3x3', 0), ('skip_connect', 2)],
                       reduce_concat=range(2, 6))
gdas_final = Genotype(normal=[('sep_conv_3x3', 1), ('skip_connect', 0),
                              ('skip_connect', 0), ('sep_conv_3x3', 1),
                              ('skip_connect', 0), ('dil_conv_5x5', 1),
                              ('dil_conv_3x3', 3), ('skip_connect', 0)],
                      normal_concat=range(2, 6),
                      reduce=[('sep_conv_3x3', 0), ('avg_pool_3x3', 1),
                              ('sep_conv_3x3', 0), ('skip_connect', 2),
