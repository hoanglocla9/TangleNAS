...
out_dir = f"output_tinystories/out_search_spos_{train_portion}_{args.seed}_{max_iters}_{timestr}"
...
if wandb_log and master_process:
    ...
    wandb_run_name = (
        f"TinyStories_searchmodel_spos_{train_portion}_{max_iters}_{args.seed}"
    )
...
while True:
    ...
    if (iter_num % eval_interval == 0 or is_last_iter) and master_process:
        ...
        if (losses["val"] < best_val_loss) or always_save_checkpoint or is_last_iter:
            best_val_loss = (
