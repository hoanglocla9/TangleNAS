...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        "Weight sharing NAS methods to search for cells.")
    ...
    parser.add_argument(
        ...
        type=str,
        choices=[
            "darts-v1", "darts-v2", "gdas", "gdas_v1", "setn", "random", "enas"
        ],
        help="The search space name.",
    )
    parser.add_argument(
    ...
    parser.add_argument("--tau_min",
                        type=float,
                        default=0.1,
                        help="The minimum tau for Gumbel Softmax.")
    parser.add_argument("--tau_max",
                        type=float,
                        default=10,
                        help="The maximum tau for Gumbel Softmax.")
    ...
    parser.add_argument("--arch_eps",
                        type=float,
                        default=1e-8,
                        help="weight decay for arch encoding")
    parser.add_argument("--drop_path_rate",
                        type=float,
                        help="The drop path rate.")
    # log
    parser.add_argument(
        "--workers",
        type=int,
    ...
    if args.overwite_epochs is None:
        args.save_dir = os.path.join(
            ...
            args.dataset,
            "{:}-affine{:}_BN{:}-{:}".format(args.algo, args.affine,
