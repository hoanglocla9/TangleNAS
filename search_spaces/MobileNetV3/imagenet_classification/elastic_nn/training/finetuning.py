...
def validate(
    ...
    dynamic_net.eval()
    #dynamic_net.set_best_net()
    #dynamic_net = dynamic_net.get_active_subnet(preserve_weight=True)
    ...
    with tqdm(
        ...
        for i, (batch_1, batch_2) in enumerate(run_manager.run_config.train_loader):
            ...
            if simultaneous_opt is True:
                ...
                output, loss = optimizer_alternating(images, labels, None, None, run_manager, args, epoch)
