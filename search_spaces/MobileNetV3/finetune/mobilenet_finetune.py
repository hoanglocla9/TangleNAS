...
from search_spaces.MobileNetV3.model_search_ofa import OFAMobileNetV3
...
from search_spaces.MobileNetV3.imagenet_classification.elastic_nn.training.finetuning import (
    train,
    validate
)
...
args.depth_list = "2,3,4"
args.manual_seed = 0
args.path = "experiments/mobilenet_finetune_5" #test"
args.seed = 9001
...
def main(args):
    ...
    ofa_network = OFAMobileNetV3(ks_list=[3, 5, 7], depth_list=[2,3,4], expand_ratio_list=[3, 4, 6])
    net = ofa_network.to(args.device)
    ...
    if global_rank == 0:
        ...
        name = f"finetune_mobilenetv3_{args.one_shot_opt}_imagenet_{args.seed}"
    ...
    try:
        ...
        run_name = f"mobilenetv3_fientune_{args.seed}"
        run_id = ""
