...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='spos',
        type=str)
    parser.add_argument('--logdir', default='./final_experiments_nats', type=str)
    ...
    parser.add_argument('--use_we_v2', default=False, action='store_true', help='Use this flag to use weight entanglement version 2. If used, this flag overrides no_weight_entanglement')
